  ...
  var DICT = {
    zh: {
      ...
      accounts: {
        ...
        addAccount: '添加账号', deleteSelected: '批量删除', deleteSelectedCount: '批量删除 ({n})', clearRegistered: '清除已注册',
        ...
        deleteConfirm: '确认删除',
        deletedOne: '账号已删除',
        noSelected: '请先勾选要删除的账号',
        deleteSelectedTitle: '批量删除账号',
        deleteSelectedMsg: '确认删除选中的 {n} 个账号？此操作不可恢复。',
      ...
      subscription: {
        ...
        batchGet: '一键获取选中', copyLinks: '复制选中链接', reload: '重新加载账号', deleteSelected: '删除选中',
        ...
        pickDeleteFirst: '请先勾选要删除的账号',
        deleteSelectedTitle: '删除选中账号',
        deleteSelectedMsg: '确认从输出账号列表删除选中的 {n} 个账号？此操作不可恢复。',
        deleteConfirm: '确认删除',
        deletedSelected: '已删除 {n} 个账号',
        deleteFailed: '删除失败',
    ...
    en: {
      ...
      accounts: {
        ...
        addAccount: 'Add account', deleteSelected: 'Delete selected', deleteSelectedCount: 'Delete selected ({n})', clearRegistered: 'Clear registered',
        ...
        noSelected: 'Please select accounts to delete',
        deleteSelectedTitle: 'Delete selected accounts',
        deleteSelectedMsg: 'Delete {n} selected accounts? This cannot be undone.',
      ...
      subscription: {
        ...
        batchGet: 'Fetch selected', copyLinks: 'Copy selected links', reload: 'Reload accounts', deleteSelected: 'Delete selected',
        ...
        pickDeleteFirst: 'Please select accounts to delete',
        deleteSelectedTitle: 'Delete selected accounts',
        deleteSelectedMsg: 'Delete {n} selected accounts from the output list? This cannot be undone.',
        deleteConfirm: 'Delete',
        deletedSelected: 'Deleted {n} accounts',
    ...
    ja: {
      ...
      accounts: {
        ...
        addAccount: 'アカウント追加', deleteSelected: '選択削除', deleteSelectedCount: '選択削除 ({n})', clearRegistered: '登録済みを削除',
        ...
        noSelected: '削除するアカウントを選択してください',
        deleteSelectedTitle: '選択アカウントを削除',
        deleteSelectedMsg: '選択中の {n} 件を削除しますか? 元に戻せません。',
      ...
      subscription: {
        ...
        batchGet: '選択した項目を取得', copyLinks: '選択リンクをコピー', reload: '再読み込み', deleteSelected: '選択項目を削除',
        ...
        pickDeleteFirst: '削除するアカウントを選択してください',
        deleteSelectedTitle: '選択したアカウントを削除',
        deleteSelectedMsg: '出力リストから選択中の {n} 件を削除しますか？この操作は元に戻せません。',
        deleteConfirm: '削除',
        deletedSelected: '{n} 件のアカウントを削除しました',
